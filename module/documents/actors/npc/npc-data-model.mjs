...
export class NpcDataModel extends foundry.abstract.TypeDataModel {
	static defineSchema() {
		...
		return {
			...
			phases: new SchemaField({ value: new NumberField({ min: 1, initial: 1, integer: true , nullable: false}) }),
			multipart: new SchemaField({ value: new StringField({ initial: '' }) }),
			isElite: new SchemaField({ value: new BooleanField({ initial: false }) }),
			isChampion: new SchemaField({ value: new NumberField({ min: 1, initial: 1, integer: true , nullable: false}) }),
			...
			study: new SchemaField({ value: new NumberField({ min: 0, max: 3, initial: 0, integer: true , nullable: false}) }),
