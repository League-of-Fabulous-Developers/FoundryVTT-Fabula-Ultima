	...
	async _preparePartContext(partId, ctx, options) {
		...
		switch (partId) {
			...
			case 'tabs':
				...
				context.features = Object.entries(CONFIG.FU.classFeatureRegistry.map).reduce((agg, [key, value]) => (agg[key] = value.translation) && agg, {});
				context.optionals = Object.entries(CONFIG.FU.optionalFeatureRegistry.map).reduce((agg, [key, value]) => (agg[key] = value.translation) && agg, {});
				break;
