 ...
 * @extends {ItemSheet}
 */
export class FUStandardItemSheet extends api.HandlebarsApplicationMixin(sheets.ItemSheetV2) {
	/**
	...
	static DEFAULT_OPTIONS = {
		...
		actions: {
			...
			// Active effects
			createEffect: FUStandardItemSheet.CreateEffect,
			editEffect: FUStandardItemSheet.EditEffect,
			deleteEffect: FUStandardItemSheet.DeleteEffect,
			toggleEffect: FUStandardItemSheet.ToggleEffect,
			copyInline: FUStandardItemSheet.CopyInline,
			rollEffect: FUStandardItemSheet.RollEffect,
		},
		scrollY: ['.sheet-body'],
